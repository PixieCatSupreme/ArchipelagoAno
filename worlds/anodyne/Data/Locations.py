...
all_locations: List[LocationData] = [
    ...
    LocationData("Apartment - 1F Flooded Room Dust", "Apartment", dust=True),
    ...
    LocationData("Mountain Cavern - 3F Top Right Moving Platform Dust", "Crowd floor 3", dust=True),
    LocationData("Mountain Cavern - 3F Roller Dust", "Crowd floor 3", dust=True),
    LocationData("Mountain Cavern - 2F Frogs and Annoyers Dust", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Rotators and Annoyers Dust 1", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Rotators and Annoyers Dust 2", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Circular Hole Dust 1", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Circular Hole Dust 2", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Crossing Moving Platforms Dust 1", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Crossing Moving Platforms Dust 2", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 1", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 2", "Crowd floor 2", dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 3", "Crowd floor 2", dust=True),
    ...
    LocationData("Fields - Lake After Spikes Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - North River Dust", "Fields", dust=True),
    LocationData("Fields - Lake After Holes Floating Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - South East of Lake Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Lake Near Windmill Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - North of Lake Rapids Dust", "Fields", dust=True),
    LocationData("Fields - North East of Lake Dust", "Fields", ["Jump Shoes"], dust=True),
    ...
    LocationData("Fields - Near Terminal Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - North West of Lake Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Near Beach Dust", "Fields", dust=True),
    LocationData("Fields - South West Corner Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - South East of Gauntlet Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Before Gauntlet Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Island Chest Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Island Start Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Post Whirlpool Dust", "Fields", ["Jump Shoes"], dust=True),
    LocationData("Fields - Olive Dust", "Fields", ["Jump Shoes"], dust=True),
    ...
    LocationData("Deep Forest - Before Inlet Chest", "Forest", dust=True),
    LocationData("Happy - Final Room Dust", "Happy", dust=True),
    LocationData("Happy - Dustmaid Dust", "Happy", dust=True),
    LocationData("Hotel - 1F Floating Dustmaid Dust", "Hotel floor 1", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 3F Hallway Dustmaid Dust 2", "Hotel floor 3", ["Keys:Hotel:1", "Jump Shoes"], dust=True),
    LocationData("Hotel - 3F Hallway Dustmaid Dust 1", "Hotel floor 3", ["Keys:Hotel:1", "Jump Shoes"], dust=True),
    LocationData("Hotel - 4F Moving Platform Crossroad 1", "Hotel floor 4", ["Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Boss Dust", "Hotel floor 1", ["Keys:Hotel:6","Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Gasguy Dust", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Dustmaid and Steampipe Dust 3", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Dustmaid and Steampipe Dust 2", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Dustmaid and Steampipe Dust 1", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    LocationData("Hotel - 1F Dustmaid and Steampipe Dust 4", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    ...
    LocationData("Hotel - 1F Locked Dust", "Hotel floor 1", ["Keys:Hotel:6", "Jump Shoes"], dust=True),
    LocationData("Hotel - 2F Dustmaid and Steampipe Dust 3", "Hotel floor 2", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 2F Dustmaid and Steampipe Dust 1", "Hotel floor 2", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 2F Dustmaid and Steampipe Dust 2", "Hotel floor 2", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 2F Dustmaid Hallway Dust", "Hotel", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 3F Stream Dustmaid Dust", "Hotel floor 3", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    LocationData("Hotel - 3F Bedroom Dust", "Hotel floor 3", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    ...
    LocationData("Hotel - 4F Spring Puzzle Dust", "Hotel floor 4", ["Keys:Hotel:1", "Jump Shoes"], dust=True),
    LocationData("Hotel - 4F Moving Platform Puzzle Dust", "Hotel floor 4", ["Keys:Hotel:1", "Jump Shoes"], dust=True),
    ...
    LocationData("Red Cave - Middle Cave Left Dust 1", "Red Cave top", dust=True),
    LocationData("Red Cave - Middle Cave Left Dust 2", "Red Cave top", dust=True),
    ...
    LocationData("Space - Challenge Area Dustmaid Dust 1", "Space", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Space - Challenge Area Dustmaid Dust 2", "Space", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Space - Challenge Area Lion Dust 1", "Space", dust=True),
    LocationData("Space - Challenge Area Lion Dust 2", "Space", dust=True),
    LocationData("Street - After Bridge Dust 1", "Street", ["Keys:Street:1"], dust=True),
    LocationData("Street - After Bridge Dust 2", "Street", ["Keys:Street:1"], dust=True),
    LocationData("Boss Rush - Before Red Boss Dust", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 1", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 2", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 3", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 4", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Manager Phase 1 Dust", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Manager Phase 2 Dust", "Boss Rush", ["Swap:2", "Jump Shoes"], dust=True)
]
