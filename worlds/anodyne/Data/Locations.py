...
all_locations: List[LocationData] = [
    ...
    LocationData("Space - Challenge Area Chest", "Space Gauntlet", ["Combat", "Jump Shoes", "Swap:2"]),
    ...
    LocationData("Space - Challenge Area Dustmaid Dust 1", "Space Gauntlet", ["Swap:2", "Jump Shoes"], dust=True),
    LocationData("Space - Challenge Area Dustmaid Dust 2", "Space Gauntlet", ["Swap:2", "Jump Shoes"], dust=True),
