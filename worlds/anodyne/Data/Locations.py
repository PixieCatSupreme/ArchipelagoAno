...
all_locations: List[LocationData] = [
    ...
    LocationData(Debug.prison, "River Puzzles Chest", [], (728, 600)),
    LocationData(Debug.prison, "Lower Prison Chest", [], (136, 1080)),
    LocationData(Debug.prison, "Upper Prison Chest", [], (72, 664)),
    LocationData(Debug.DEFAULT, "Jumping Chest", [], (872, 56)),
    LocationData(Debug.prison, "Maze Chest", ["Jump Shoes"], (888, 1496)),
    ...
    LocationData(Forest.inlet, "Inlet Chest", ["Combat"], (536, 392)),
    # This is the one that takes 2 hours
    LocationData(Forest.west, "Bunny Chest", ["Progressive Swap:2"], (88, 88)),
    ...
    LocationData(Forest.west, "Warp Pad", [], (240, 1040), type=LocationType.Nexus),
    ...
    LocationData(Forest.west, "Relaxation Pond Dust", [], (360, 696), type=LocationType.Dust),
    LocationData(Forest.east, "Near Cliff Dust", [], (696, 1144), type=LocationType.Dust),
    LocationData(Forest.west, "Floating Dust", [], (200, 1176), type=LocationType.Dust),
    LocationData(Forest.west, "Thorax Dust", [], (88, 1144), type=LocationType.Dust),
    LocationData(Forest.lake, "Carved Rock Dust", [], (72, 1416), type=LocationType.Dust),
    LocationData(Forest.east, "Tiny Island Dust", [], (296, 1416), type=LocationType.Dust),
    LocationData(Forest.inlet, "Inlet Dust", [], (568, 440), type=LocationType.Dust),
    LocationData(Forest.east, "Before Inlet Dust", [], (600, 792), type=LocationType.Dust),
    ...
    LocationData(Debug.prison, "Prison Rock", [], (680, 840), LocationType.Rock),
    ...
    LocationData(Forest.west, "Relaxation Pond Rock", [], (392, 776), LocationType.Rock),
    LocationData(Forest.lake, "Carved Rock", [], (40, 1400), LocationType.Rock),
    LocationData(Forest.west, "Nexus Pad Rock", [], (264, 1000), LocationType.Rock),
    LocationData(Forest.east, "Near Cliffs Rock", [], (744, 1160), LocationType.Rock),
    ...
    LocationData(Nexus.ending, "Post Gate Rock", [], (728, 378), LocationType.Rock),
