...
all_locations: List[LocationData] = [
    ...
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Slasher Chest", ["Combat"]),
    # 72BAD10E-598F-F238-0103-60E1B36F6240
    LocationData(Red_Cave.center, "Red Grotto - Middle Cave Right Chest", type=LocationType.Key),
    # AE87F1D5-57E0-1749-7E1E-1D0BCC1BCAB4
    LocationData(Red_Cave.center, "Red Grotto - Middle Cave Left Chest", ["Combat"], type=LocationType.Key),
    LocationData(Red_Cave.center, "Red Grotto - Middle Cave Middle Chest", ["Small Key (Red Grotto):6"]),
    LocationData(Red_Cave.exit, "Red Grotto - Boss Chest", []),
    # 4A9DC50D-8739-9AD8-2CB1-82ECE29D3B6F
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Rapids Chest", ["Combat"], type=LocationType.Key),
    # A7672339-F3FB-C49E-33CE-42A49D7E4533
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Slasher Chest", ["Combat"], type=LocationType.Key),
    # 83286BFB-FFDA-237E-BA57-CA2E532E1DC7
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Four Shooter Chest", ["Combat"], type=LocationType.Key),
    # CDA1FF45-0F88-4855-B0EC-A9B42376C33F
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Sticky Chest", ["Combat"], type=LocationType.Key),
    LocationData(Red_Cave.bottom, "Red Grotto - Widen Upgrade Chest", outside_of_dungeon=True),
    LocationData(Red_Cave.Isaac, "Red Grotto - Isaac Dungeon Chest", ["Combat"], outside_of_dungeon=True),
    ...
    LocationData(Red_Cave.top, "Red Grotto - Health Cicada", ["Defeat Rogue"], type=LocationType.Cicada),
    ...
    LocationData(Red_Cave.exit, "Red Grotto - Red Key", [], type=LocationType.BigKey),
    LocationData(Crowd.exit, "Mountain Cavern - Blue Key", [], type=LocationType.BigKey),
    LocationData(Red_Cave.center, "Red Grotto - Middle Cave Left Tentacle", ["Combat"], type=LocationType.Tentacle),
    LocationData(Red_Cave.center, "Red Grotto - Middle Cave Right Tentacle", [], type=LocationType.Tentacle),
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Tentacle", ["Small Key (Red Grotto):6"], type=LocationType.Tentacle),
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Tentacle", ["Small Key (Red Grotto):6"], type=LocationType.Tentacle),
    ...
    LocationData(Red_Cave.exit, "Red Grotto - Warp Pad", type=LocationType.Nexus),
    ...
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Boss Dust 1", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Boss Dust 2", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Before Boss Dust", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Slasher Dust", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Before Slasher Dust", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Boss Dust 3", type=LocationType.Dust),
    LocationData(Red_Cave.top, "Red Grotto - Top Cave Boss Dust 4", type=LocationType.Dust),
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Rapids Dust 1", type=LocationType.Dust),
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Rapids Dust 2", type=LocationType.Dust),
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Before Slasher Dust", type=LocationType.Dust),
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Whirlpool Dust 1", type=LocationType.Dust),
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Whirlpool Dust 1", type=LocationType.Dust),
    LocationData(Red_Cave.left, "Red Grotto - Left Cave Whirlpool Dust 2", type=LocationType.Dust),
    LocationData(Red_Cave.right, "Red Grotto - Right Cave Whirlpool Dust 2", type=LocationType.Dust),
