...
all_exits: list[Connection] = [
    ...
    (Apartment.floor_1, Apartment.floor_2, ["Jump Shoes", "Small Key (Apartment):1"]),
    (Apartment.floor_2, Apartment.floor_1, []),
    (Apartment.floor_1, Apartment.floor_2_rat_maze, ["Combat", "Jump Shoes"]),
    ...
    (Bedroom.entrance, Bedroom.swapper_entrance, ["Progressive Swap:2"]),
    (Bedroom.swapper_entrance, Bedroom.entrance, ["Progressive Swap:2"]),
    ...
    (Overworld.post_windmill, Bedroom.exit,
     ["Temple of the Seeing One Statue", "Small Key (Temple of the Seeing One):3",
      "Combat"]),
    (Overworld.gauntlet, Overworld.station, ["Progressive Swap:2", "Combat"]),
    (Overworld.station, Overworld.gauntlet, ["Progressive Swap:2", "Combat"]),
    (Bedroom.drawer, Drawer.DEFAULT, ["Progressive Swap:2"]),
    (Drawer.DEFAULT, Bedroom.drawer, ["Progressive Swap:2"]),
    (Bedroom.drawer, Overworld.station, []),
    (Overworld.station, Bedroom.drawer, []),
    (Overworld.station, Overworld.color_puzzle_hint, ["Progressive Swap:2"]),
    (Overworld.color_puzzle_hint, Overworld.station, ["Progressive Swap:2"]),
    (Overworld.post_windmill, Overworld.out_of_bounds_south, ["Progressive Swap:2"]),
    (Overworld.out_of_bounds_south, Overworld.post_windmill, ["Progressive Swap:2"]),
    (Overworld.DEFAULT, Overworld.gauntlet, [OverworldGauntletGate.typename(), "Combat"]),
    (Overworld.gauntlet, Overworld.DEFAULT,  [OverworldGauntletGate.typename(), "Combat"]),
    ...
    (Forest.west, Forest.lake, []), # Dust sailing
    (Forest.lake, Forest.west, []),
    (Forest.east, Forest.lake, ["Combat"]),
    (Forest.lake, Forest.east, []),
    (Forest.east, Forest.inlet, ["Combat"]),
    (Forest.inlet, Forest.east, ["Combat"]),
    (Forest.east, Cliffs.DEFAULT, []),
    (Cliffs.DEFAULT, Forest.east, []),
    ...
    (Fields.East, Forest.west, ["Combat"]),
    (Forest.west, Fields.East, []),
    ...
    (Fields.DEFAULT, Windmill.entrance, []),
    (Windmill.entrance, Fields.DEFAULT, []),
    (Windmill.entrance, Windmill.blank, ["Progressive Swap:2"]),
    (Windmill.blank, Windmill.entrance, ["Progressive Swap:2"]),
    (Blank.windmill, Windmill.blank, []),
    (Windmill.blank, Blank.windmill, []),
    (Windmill.entrance, Windmill.first_gate, [WindmillEntranceGate.typename()]),
    (Windmill.first_gate, Windmill.entrance, [WindmillEntranceGate.typename()]),
    (Windmill.first_gate, Windmill.second_gate, [WindmillMiddleGate.typename()]),
    (Windmill.second_gate, Windmill.first_gate, [WindmillMiddleGate.typename()]),
    (Windmill.second_gate, Windmill.third_gate, [WindmillTopGate.typename()]),
    (Windmill.third_gate, Windmill.second_gate, [WindmillTopGate.typename()]),
