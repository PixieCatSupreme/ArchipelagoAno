...
all_locations: List[LocationData] = [
    ...
    LocationData("Hotel - 2F Dustmaid Hallway Dust", "Hotel floor 2", ["Keys:Hotel:4", "Jump Shoes"], dust=True),
    ...
    LocationData("Red Cave - Middle Cave Left Dust 1", "Red Cave middle", dust=True),
    LocationData("Red Cave - Middle Cave Left Dust 2", "Red Cave middle", dust=True),
