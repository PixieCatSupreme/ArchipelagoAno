...
all_locations: List[LocationData] = [
    ...
    LocationData("Apartment - 1F Ledge Chest", "Apartment floor 1", ["Broom", "Jump Shoes"], small_key=True),
    # DE415E2A-06EE-83AC-F1A3-5DCA1FA44735
    LocationData("Apartment - 1F Rat Maze Chest", "Apartment floor 1", ["Broom", "Jump Shoes"], small_key=True),
    LocationData("Apartment - 1F Exterior Chest", "Apartment floor 1", ["Broom", "Jump Shoes"]),
    LocationData("Apartment - 1F Couches Chest", "Apartment floor 1 top left", ["Broom", "Jump Shoes"]),
    # 5B55A264-3FCD-CF38-175C-141B2D093029
    LocationData("Apartment - 2F Rat Maze Chest", "Apartment floor 2", ["Broom", "Jump Shoes"], small_key=True),
    # 2BBF01C8-8267-7E71-5BD4-325001DBC0BA
    LocationData("Apartment - 3F Gauntlet Chest", "Apartment floor 3", ["Broom"], small_key=True),
    ...
    LocationData("Temple of the Seeing One - Shieldy Room Chest", "Bedroom",
                 ["Broom", "Keys:Temple of the Seeing One:2"]),
    LocationData("Temple of the Seeing One - Rock-Surrounded Chest", "Bedroom", ["Broom"]),
    ...
    LocationData("Temple of the Seeing One - After Statue Left Chest", "Bedroom exit",
                 ["Broom", "Temple of the Seeing One Statue"], small_key=True),
    LocationData("Temple of the Seeing One - After Statue Right Chest", "Bedroom exit",
                 ["Broom", "Temple of the Seeing One Statue"]),
    # 401939A4-41BA-E07E-3BA2-DC22513DCC5C
    LocationData("Temple of the Seeing One - Dark Room Chest", "Bedroom", ["Broom"], small_key=True),
    LocationData("Blank - Card Chest", "Blank windmill"),
    LocationData("Cell - Top Left Chest", "Cell", ["Jump Shoes"]),
    LocationData("Cell - Chaser Gauntlet Chest", "Cell", ["Swap:2", "Broom", "Jump Shoes"]),
    # 75C2D434-4AE8-BCD0-DBEB-8E6CDA67BF45
    LocationData("Circus - Rat Maze Chest", "Circus", ["Broom", "Jump Shoes"], small_key=True),
    LocationData("Circus - Clowns Chest", "Circus", ["Broom", "Jump Shoes"]),
    LocationData("Circus - Fire Pillar Chest", "Circus", ["Broom", "Jump Shoes"]),
    # 69E8FBD6-2DA3-D25E-446F-6A59AC3E9FC2
    LocationData("Circus - Arthur Chest", "Circus", ["Broom", "Jump Shoes"], small_key=True),
    # 6A95EB2F-75FD-8649-5E07-3ED37C69A9FB
    LocationData("Circus - Javiera Chest", "Circus", ["Broom", "Jump Shoes"], small_key=True),
    # A2479A02-9B0D-751F-71A4-DB15C4982DF5
    LocationData("Circus - Lion Chest", "Circus", ["Broom", "Jump Shoes"], small_key=True),
    LocationData("Circus - Double Clowns Chest", "Circus", ["Broom", "Jump Shoes"]),
    LocationData("Circus - Boss Chest", "Circus", ["Defeat Servants", "Broom", "Jump Shoes"]),
    LocationData("Cliffs - Upper Chest", "Cliff post windmill"),
    LocationData("Cliffs - Lower Chest", "Cliff post windmill"),
    LocationData("Mountain Cavern - 2F Crowded Ledge Chest", "Crowd floor 2", ["Broom", "Jump Shoes"]),
    # BE2FB96B-1D5F-FCD1-3F58-D158DB982C21
    LocationData("Mountain Cavern - 2F Four Enemies Chest", "Crowd floor 2", ["Broom"], small_key=True),
    # 5743A883-D209-2518-70D7-869D14925B77
    LocationData("Mountain Cavern - 2F Entrance Chest", "Crowd floor 2", ["Broom", "Jump Shoes"], small_key=True),
    # 21EE2D01-54FB-F145-9464-4C2CC8725EB3
    LocationData("Mountain Cavern - 2F Frogs and Dog Chest", "Crowd floor 2", ["Broom", "Jump Shoes"], small_key=True),
    LocationData("Mountain Cavern - 3F Roller Chest", "Crowd floor 3",
                 ["Broom", "Jump Shoes", "Keys:Mountain Cavern:3"]),
    ...
    LocationData("Mountain Cavern - 2F Frogs and Rotators Chest", "Crowd floor 2", ["Broom", "Jump Shoes"],
                 small_key=True),
    LocationData("Debug - River Puzzles Chest", "Debug", ["Broom", "Jump Shoes"]),
    ...
    LocationData("Fields - Island Chest", "Fields", ["Broom"]),
    LocationData("Fields - Gauntlet Chest", "Fields", ["Broom"]),
    LocationData("Fields - Goldman's Cave Chest", "Fields", ["Broom"]),
    LocationData("Fields - Blocked River Chest", "Fields", ["Swap:2"]),
    ...
    LocationData("Deep Forest - Inlet Chest", "Forest", ["Broom"]),
    ...
    LocationData("Hotel - 4F Annoyers Chest", "Hotel floor 4", ["Broom", "Jump Shoes"], small_key=True),
    LocationData("Hotel - 4F Dust Blower Maze Chest", "Hotel floor 4", ["Broom", "Jump Shoes", "Keys:Hotel:1"]),
    LocationData("Hotel - 3F Dashers Chest", "Hotel floor 3", ["Keys:Hotel:6"]),
    # 64EE884F-EA96-FB09-8A9E-F75ABDB6DC0D
    LocationData("Hotel - 3F Gasguy Chest", "Hotel floor 3", ["Broom"], small_key=True),
    # 075E6024-FE2D-9C4A-1D2B-D627655FD31A
    LocationData("Hotel - 3F Rotators Chest", "Hotel floor 3", ["Broom"], small_key=True),
    LocationData("Hotel - 2F Dog Chest", "Hotel floor 2 right", ["Broom"]),
    ...
    LocationData("Hotel - 2F Backrooms Chest", "Hotel floor 2", ["Broom"], small_key=True),
    ...
    LocationData("Overworld - After Temple Chest", "Overworld post windmill"),
    LocationData("Red Cave - Top Cave Slasher Chest", "Red Cave top", ["Broom"]),
    ...
    LocationData("Red Cave - Middle Cave Left Chest", "Red Cave center", ["Broom"], small_key=True),
    ...
    LocationData("Red Cave - Left Cave Rapids Chest", "Red Cave left", ["Broom"], small_key=True),
    ...
    LocationData("Red Cave - Left Cave Sticky Chest", "Red Cave left", ["Broom"], small_key=True),
    LocationData("Red Cave - Widen Upgrade Chest", "Red Cave bottom"),
    LocationData("Red Cave - Isaac Dungeon Chest", "Red Cave Isaac", ["Broom"]),
    ...
    LocationData("Young Town - Killers Chest", "Suburb", ["Broom", "Swap:2"]),
    LocationData("Space - Left Chest", "Space"),
    LocationData("Space - Right Chest", "Space"),
    LocationData("Space - Challenge Area Chest", "Space", ["Broom", "Swap:2"]),
    # Wiggle glitch available
    LocationData("Space - Hidden Chest", "Space"),
    # 3307AA58-CCF1-FB0D-1450-5AF0A0C458F7
    LocationData("Street - Key Chest", "Street", ["Broom"], small_key=True),
    ...
    LocationData("Boss Rush - Reward Chest", "Boss Rush", ["Broom"]),
    ...
    LocationData("Temple of the Seeing One - Health Cicada", "Bedroom exit", ["Broom"], health_cicada=True),
    # Has to be frame 4
    ...
    LocationData("Young Town - Health Cicada", "Suburb", ["Broom"], health_cicada=True),
